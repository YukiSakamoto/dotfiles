...
ruby << EOC
	def append(s)
		...
		buf.append(buf.line_number,s)
	end
	append Time.now.to_s
EOC
endif
endfunction
...
ruby << EOC
	...
	Twitter.configure do |config|
		config.consumer_key = 'Rc8iO9PXfQWVyLuaU3wQ5Q'
		config.consumer_secret = 'tGPa2493U5jwic9ugJnJ8hIfzkyr81vsRIgSfRSU4RM'
		config.oauth_token = '293873879-6fGnpvKTtXvrmyaXzcRUACP9XRXpTv1xaSZFRQxQ'
		config.oauth_token_secret = 'Eg0A6fOnxceofnrU531iGfePMky5aAgo9CNIkDus'
	end
	string = Vim.evaluate('GetVisual()')
	string.sub!(/^\s/, "")
